...
import { DonorAdvisedFunds } from "./api/resources/donorAdvisedFunds/client/Client";
...
export class ChariotClient {
    ...
    protected _donorAdvisedFunds: DonorAdvisedFunds | undefined;

    public get donorAdvisedFunds(): DonorAdvisedFunds {
        return (this._donorAdvisedFunds ??= new DonorAdvisedFunds(this._options));
    }
