...
export declare namespace UnintegratedGrants {
    interface Options {
...
export class UnintegratedGrants {
    constructor(protected readonly _options: UnintegratedGrants.Options = {}) {}

    /**
     * Returns a list of all unintegrated grants for a given Connect. This API allows for paginating over many results.
     *
     * @param {Chariot.UnintegratedGrantsListRequest} request
     * @param {UnintegratedGrants.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async list(
        ...
        const list = async (
            request: Chariot.UnintegratedGrantsListRequest
        ): Promise<Chariot.UnintegratedGrantsListResponse> => {
            ...
            if (_response.ok) {
                return serializers.UnintegratedGrantsListResponse.parseOrThrow(_response.body, {
        ...
        return new core.Pageable<Chariot.UnintegratedGrantsListResponse, Chariot.UnintegratedGrant>({
     ...
     * @param {string} id - The unique id of the unintegrated grant.
     *                      The format should be a v4 UUID according to RFC 4122.
     * @param {Chariot.UnintegratedGrantsUpdateRequest} request
     * @param {UnintegratedGrants.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @throws {@link Chariot.BadRequestError}
     * @throws {@link Chariot.UnauthorizedError}
    ...
    public async update(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.UnintegratedGrantsUpdateRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
